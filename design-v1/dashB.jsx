...
function DashboardB() {
  ...
  return (
    <div dir="rtl" style={{ width: 1360, height: 940, background: '#f7f5fc', fontFamily: 'Rubik, sans-serif', color: TOK.body, padding: '22px 26px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {/* hero greeting */}
      <div style={{ position: 'relative', borderRadius: 24, padding: '20px 28px', marginBottom: 14, overflow: 'hidden',
      ...
      {/* stat tiles */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 16, marginBottom: 14, flexShrink: 0 }}>
        {tiles.map((t) => (
      ...
      {/* chart + goals */}
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 16, marginBottom: 14, flexShrink: 0 }}>
        <div style={{ background: '#fff', borderRadius: 22, padding: '16px 24px 8px', boxShadow: '0 2px 8px rgba(28,21,48,0.05)' }}>
          ...
          <BarChart data={pts} labels={months} w={780} h={166} color={TOK.purple300} activeColor={TOK.purple600} active={7} bw={0.46} />
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: 16, flex: 1, minHeight: 0 }}>
        <div style={{ background: '#fff', borderRadius: 22, padding: '18px 22px', boxShadow: '0 2px 8px rgba(28,21,48,0.05)', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {feed.map((f, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 13, padding: '6px 0', borderTop: i ? `1px solid ${TOK.line2}` : 'none' }}>
